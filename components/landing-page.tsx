        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="max-w-2xl mx-auto text-center space-y-8">
            ...
            <div className="pt-8 space-y-4">
              <p className="text-sm font-medium text-muted-foreground">Coming soon to</p>
              <div className="flex items-center justify-center gap-4">
                {/* Apple App Store Badge */}
                <div className="flex items-center gap-2 px-4 py-3 rounded-lg border border-border bg-card hover:bg-accent/50 transition-colors cursor-not-allowed opacity-75">
